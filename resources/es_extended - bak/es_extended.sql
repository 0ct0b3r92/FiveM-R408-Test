...
ALTER TABLE `users`
  ...
  ADD COLUMN `job` varchar(255) NULL DEFAULT 'survivor' AFTER `skin`,
...
INSERT INTO `job_grades` VALUES (1,'survivor',0,'lvl1','Level 1',0,'{}','{}');
...
INSERT INTO `jobs` VALUES (1,'survivor','Survivor');
