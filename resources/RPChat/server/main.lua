  ...
  RegisterCommand('radio', function(source, args, user)
  	TriggerClientEvent('chatMessage', -1, "^3[RADIO BROADCAST]: " .. GetPlayerName(source), {255,215,0}, table.concat(args, " "))
  end, false)
  
  RegisterCommand('reapopen', function(source, args, user)
  	TriggerClientEvent('chatMessage', -1, "^1[REAPER OPEN COMMS]: " .. GetPlayerName(source), {255,215,0}, table.concat(args, " "))
  end, false)
  
  RegisterCommand('lssopen', function(source, args, user)
  	TriggerClientEvent('chatMessage', -1, "^4[LSS OPEN COMMS]: " .. GetPlayerName(source), {255,215,0}, table.concat(args, " "))
  end, false)
  
  RegisterCommand('undeadmcopen', function(source, args, user)
  	TriggerClientEvent('chatMessage', -1, "^1[UNDEAD MC OPEN COMMS]: " .. GetPlayerName(source), {255,215,0}, table.concat(args, " "))
  end, false)
