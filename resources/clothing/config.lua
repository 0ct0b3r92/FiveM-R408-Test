...
menu_options = {
    ...
    --{name = "Player models", f = listModels, param = player_models},
...
local clothing_shops = {
    {name="Junkyard Clothing", id=73, x=2488.09,  y=4960.58, z=44.80},
    {name="Grapeseed Clothing", id=73, x=2423.33,  y=3130.44, z=48.20},
    {name="NRF Faction Clothing", id=73, x=-1074.87,  y=4944.29, z=213.64},
    {name="City Safe Zone Clothing", id=73, x=157.98,  y=-1075.44, z=29.39},
}
incircle = false
    ...
    while true do
        ...
        for k,v in ipairs(clothing_shops) do
            if(Vdist(pos.x, pos.y, pos.z, v.x, v.y, v.z) < 15.0)then
                DrawMarker(1, v.x, v.y, v.z - 1, 0, 0, 0, 0, 0, 0, 1.5, 1.5, 0.5001, 1555, 0, 0,165, 0, 0, 0,0)
...
-- Keeps the player unfrozen and not godded if menu isn't opened
Citizen.CreateThread(function()
	while true do
		Citizen.Wait(1)
		if not clothing_menu then
