...
{    
    ...
    */
    loadingMessages:
    [
        "TIP: Find loot at black X marks.",
        "TIP: Zombies are more attracted to noise and have a low seeing range.",
        "TIP: Be sure to make use of /me, /do, /ad, and /ooc.",
        "TIP: To open ZSR menu (holds Inventory and Group MEnu) Press U key on your keyboard.",
        "TIP: You can kill a wide variety of animals and harvest them.",
        "TIP: You can drink dirty water from lakes.",
        "TIP: Red question mark icons are looter camps.",
        "TIP: Chat bubbles on the map are the blips for the missions.",
        "TIP: Make sure you read the rules precisely. You ARE responsible if you break them.",
        "TIP: To see list of changes, type /changelog in-game.",
        "TIP: Make use of the /help command and read the help screen after joining.",
        "TIP: Change clothes inside safe zones where the shirt icon is.",
        "TIP: RDM/KoS will get you banned.",
        "TIP: Make sure voice chat is turned on.",
    ],
