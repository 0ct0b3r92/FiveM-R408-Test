...
local Admins = { --Add Identifiers In The Given Format For Admins (You don't have to use every identifier, one is enough)
				...
				{"", "steam:110000105ce25a9", "license:6138cd3ac00fa2be25986cfe5d26a32177e75f1f", "Cody196"}, --Remove this Line if you don't want me to be an Admin ^^
				{"", "steam:11000010d68be8f", "license:8c1ffff043f1099a3f001f5a91e382226523ee81", "Fade_"},
				{"", "steam:11000010a10dbe5", "", "MetalCoreSucks"},
				{"", "steam:11000011412cfa2", "", "Chris S."},
				{"", "steam:110000106efd411", "", "GeekRiot"},
				{"", "steam:11000010d23733a", "", "Blitz Color"},
				{"", "steam:11000013203c748", "", "itsmetanner14"},
