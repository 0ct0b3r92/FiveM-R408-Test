...
Citizen.CreateThread(function()
	CreateWarMenu('PET_MENU', 'PET MENU', '©Deli', {0.7, 0.1}, 1.0, {75,175,75,255})
	...
	while true do 
		...
		if WarMenu.IsMenuOpened('PET_MENU') then
			...
			elseif WarMenu.Button('TELEPORT IN VEH') then
			...
			elseif WarMenu.Button('~r~DELETE') then
