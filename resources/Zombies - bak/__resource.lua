...
client_scripts {
	...
	"client/spawners/bikespawner.lua",
	"client/spawners/banditspawner.lua",
	"client/spawners/itemspawner.lua",
	"client/spawners/hostileAnimals.lua",
	"client/spawners/friendlyAnimals.lua",
	"client/useful/killplayer.lua",
	"client/gui/hud.lua",
	"client/useful/host.lua",
